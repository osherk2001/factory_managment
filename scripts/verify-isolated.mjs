...
const commands = {
  ...
  dev: ["node_modules/next/dist/bin/next", "dev", "--hostname", "127.0.0.1", "--port", "3100"],
};
const command = commands[process.argv[2]];
if (!command) throw new Error("Expected migrate, test, e2e, seed, or dev");
const result = spawnSync(process.execPath, [...command, ...process.argv.slice(3)], {
  stdio: "inherit", env: { ...process.env, DATABASE_URL: databaseUrl.toString(), SEED_ENV: "development", PLAYWRIGHT_PORT: "3100" },
});
