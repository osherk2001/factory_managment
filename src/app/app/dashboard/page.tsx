              ...
              <Link
                ...
                className={`group flex flex-col justify-between rounded-2xl border p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${
                  isCompleted
                    ...
                    : isInProgress
                      ? "border-blue-200 bg-blue-50/40 hover:border-blue-500"
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            [
              ...
              data.urgent,
              "urgent",
              <AlertTriangle key="urg" className="h-5 w-5 text-red-600" />,
            ],
            [
              o.delayed,
              data.delayed,
              "delayed",
              <Clock key="del" className="h-5 w-5 text-amber-600" />,
            ],
            ...(data.issues === null
              ? []
              : [
                  [
                    ...
                    data.issues,
                    "issues",
                    <AlertCircle key="iss" className="h-5 w-5 text-rose-600" />,
                  ],
                ]),
